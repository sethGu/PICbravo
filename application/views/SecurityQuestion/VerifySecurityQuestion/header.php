...
<html lang="en">
  <head>
    ...
    <title>Change password</title>
      <style>
          ...
          .mbbb{font-size: 24px; color: grey;}
  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      xhr.onload = function(){
        const serverResponse = document.getElementById("forgotPW");
        forgotPW.innerHTML
      }
    </script>
  ...
  <a class="nav-item nav-link disabled" href="#">Change password</a>
      ...
      <div class="joincard">
          <div class="tabs tabs--large">
              <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="#">Verify security questions</a>
                  </li>
              </ul>
          </div>